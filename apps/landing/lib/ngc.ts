    ...
    points: [
      {
        id: "1",
        content:
          "Power flows from the people upward, ensuring governance remains accountable and participatory.",
      },
      {
        id: "2",
        content:
      ...
      },
      {
        id: "6",
        content:
          "Governance is continually evaluated and improved to meet the evolving needs of society.",
      },
      {
        id: "7",
        content:
          "Civic education and public engagement ensure an informed and active citizenry.",
      },
      {
        id: "8",
        content:
        ...
        subSections: [
          {
            ...
            title: "Term:",
            content:
              "6 years, with one-third of members rotating every 2 years.",
          },
          {
            id: "1",
            title: "Conflict-of-Interest Rules:",
      ...
      },
      {
        ...
        subSections: [
          ...
          },
          {
            ...
            title: "Conflict-of-Interest Rules:",
            content:
              "Members must disclose any financial or professional ties to businesses or labor unions.",
          },
          {
            id: "1",
            title: "Removal:",
...
export const AnnexOaths: SubSection[] = [
  {
    id: "1",
    title:
      "Oath of Office for Elected Officials (Community, Regional, Federated Levels)",
    content:
