  ...
  return (
    <div className="space-y-4 max-w-5xl mx-auto">
      ...
      <p className="text-muted-foreground">
        Each role supports safe, coordinated response. Use this guide to
        understand expectations and match volunteers to appropriate roles.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {sortedDetails.map(
          ({ role, description, requiredSkills, riskLevel, bestSuitedFor }) => (
            <Card key={role}>
