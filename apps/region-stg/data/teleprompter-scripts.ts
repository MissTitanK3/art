 ...
 *
 * Fill-in guidance for presenters (edit before presenting):
 * - [ORG] => Organization identifier (e.g., ART)
 * - [NAMES] => List of speaker/team names
 * - [LEAD_NAME] => Today's lead
 * - [LOCATION] => Site/location name
 * - [CHANNEL] => Primary comms channel
 * - [BACKUP_CHANNEL] => Backup comms channel
 * - [DISPATCH_CONTACT] => How to reach dispatch lead (name/number/handle)
 * - [RENDEZVOUS_POINT] => Physical regroup location
 * - [SYNC_MINUTE] => Time sync (e.g., :15 or :30)
 * - [MISSION] => Specific objective for this operation
 * - [MEDIA_LEAD] => Media lead/contact
 * - [PARTNERS] => Key partner orgs
 * - [BOUNDARIES] => Any local boundaries or constraints
 */
