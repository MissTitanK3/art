...
import BugReportList, { type BugReportRow } from '@workspace/ui/components/admin/bug-reports/BugReportList';
import type { BugArea, BugStatus } from '@workspace/ui/components/admin/bug-report-selects';
...
export default function BugReportListDataLayer() {
  ...
  const [sortBy, setSortBy] = React.useState<'created_at' | 'priority' | 'status' | 'title'>('created_at');
