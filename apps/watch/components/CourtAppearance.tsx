    ...
    <div className="bg-yellow-200 border-l-4 border-yellow-500 text-black p-8 rounded-xl shadow-sm my-6">
      ...
      <div className="my-5">
        <Link
          ...
          href={
            "https://www.tiktok.com/@victorywar01/video/7509510403471248671?is_from_webapp=1&sender_device=pc"
          }
        >
          TikTok @victorywar01
        </Link>
      ...
      <p className="mb-2">
        {t("dismissalIntroStart")}{" "}
        <strong>{t("dismissalIntroHighlight1")}</strong>{" "}
        {t("dismissalIntroMid")}{" "}
