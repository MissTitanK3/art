...
export const TRANSLATIONS: {
  ...
  en: {
    ...
    homeTitle: 'ART Watch',
    privacyTagline: 'Privacy-safe community reporting for ICE and law enforcement presence.',
  ...
  es: {
    ...
    privacyTagline: 'Reportes comunitarios seguros y privados sobre ICE y presencia policial.',
