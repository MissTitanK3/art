...
export const MDX_COURSE_FRONTMATTER = {
  ...
  'proton-secure-communication': {"title":"Using Proton & CryptPad for Secure Activism & Communication","slug":"proton-secure-communication","description":"Learn to use Proton and CryptPad to replace surveillance-based tools with encrypted, privacy-respecting systems for activist, dispatch, and mutual aid operations.","type":"qualified","readingTime":70,"version":1.1},
