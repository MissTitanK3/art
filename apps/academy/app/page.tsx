  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-4 py-20 gap-16 bg-background">
      ...
      <div className="max-w-2xl text-sm text-muted-foreground text-center space-y-3 mt-8 px-2">
        <p>
          <strong>The Academy</strong> is a self-paced, community-powered
          learning hub. It equips everyday people with the tools, skills, and
          situational awareness needed to respond to state violence, protect
          vulnerable neighbors, and coordinate effective resistance.
        </p>

        <p>
          Whether you&apos;re joining a field team, dispatching reports, or just
          want to understand your rights—this is where you start.
        </p>
      </div>
