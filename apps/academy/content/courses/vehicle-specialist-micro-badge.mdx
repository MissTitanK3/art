...
<Mermaid chart={`
graph TB
    A[Route Blocked]:::nodeStyle --> B{Threat Level?}:::nodeStyle
    B -->|High Visible Risk| C[Execute Pre-Planned Alt Route]:::nodeStyle
    B -->|Unclear| D[Contact Dispatch for Guidance]:::nodeStyle
    C --> E[Confirm Safe Arrival at Staging or Drop Point]:::nodeStyle
    D --> F[Receive New Secure Coordinates]:::nodeStyle
