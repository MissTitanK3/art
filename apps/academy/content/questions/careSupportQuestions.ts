...
export const careSupportQuestions: Question[] = [
  ...
  },
  {
    id: 'q2',
    type: 'true_false',
    question: 'It’s okay to offer physical comfort like a hug without asking, as long as you mean well.',
    correct: false,
  },
  {
    id: 'q3',
    type: 'multiple_select',
    question: 'Which of the following are appropriate trauma responses someone might have?',
    options: [
      'Crying or shaking',
      'Laughing nervously',
  ...
  },
  {
    id: 'q4',
    type: 'multiple_choice',
    question: 'What’s one way you can check if someone is open to emotional support?',
    options: [
  ...
  },
  {
    id: 'q6',
    type: 'true_false',
    question: 'You should skip offering support if you’re not a trained therapist.',
    correct: false,
  },
  {
    id: 'q7',
  ...
  },
  {
    id: 'q8',
    type: 'multiple_select',
    question: 'Which of the following should you avoid doing when someone is in distress?',
    options: [
  ...
  },
  {
    id: 'q9',
    type: 'multiple_choice',
    question: 'Which role is most focused on helping teammates decompress after an action?',
  ...
  },
  {
    id: 'q10',
    type: 'multiple_choice',
    question: 'Before offering emotional care, what should you check in with yourself about?',
    options: [
  ...
  },
  {
    id: 'q11',
    type: 'multiple_choice',
    question: 'How might you adjust your care for someone from a different cultural background?',
    options: [
