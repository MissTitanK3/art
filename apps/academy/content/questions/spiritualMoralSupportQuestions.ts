...
export const spiritualMoralSupportQuestions: Question[] = [
  {
    ...
    question: 'What is the primary purpose of the Spiritual & Moral Support role?',
    options: [
  ...
  },
  {
    id: 'q2',
    type: 'true_false',
    question: 'Volunteers in this role are allowed to proselytize or share their personal faith to comfort others.',
    correct: false,
  },
  {
    id: 'q3',
  ...
  },
  {
    id: 'q4',
    type: 'multiple_choice',
    question: 'What should a Spiritual & Moral Support volunteer do if their presence begins escalating tensions?',
    options: [
  ...
  },
  {
    id: 'q5',
    type: 'true_false',
    question: 'This role requires formal faith or religious training to become certified.',
    correct: false,
  },
  {
    id: 'q6',
    type: 'multiple_choice',
    question: 'Which identifier is recommended for this role when visibility is appropriate?',
    options: [
  ...
  },
  {
    id: 'q10',
    type: 'multiple_select',
    question: 'Which items are required for this badge’s certification checklist?',
    options: [
