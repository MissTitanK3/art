...
export const communityConsentQuestions: Question[] = [
  ...
  },
  {
    id: 'q4',
    type: 'true_false',
    question: 'If a family or group directly asks you not to show up, you should respect their wishes and not go.',
    correct: true,
  },
  {
    id: 'q5',
  ...
  },
  {
    id: 'q7',
    type: 'multiple_select',
    question: 'Which of the following are tools for practicing community consent?',
    options: [
  ...
  },
  {
    id: 'q8',
    type: 'multiple_choice',
    question: 'Why is informed consent not always the same as meaningful consent?',
    options: [
  ...
  },
  {
    id: 'q11',
    type: 'true_false',
    question: 'Consent from a single community leader always represents the whole group.',
    correct: false,
  },
  {
    id: 'q12',
    type: 'multiple_choice',
    question: 'What is a key limitation of only providing consent forms in English?',
    options: [
