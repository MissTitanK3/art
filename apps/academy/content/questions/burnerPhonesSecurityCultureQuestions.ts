...
export const burnerPhonesSecurityCultureQuestions: Question[] = [
  {
    ...
    question: 'Why are burner phones valuable for mutual aid and direct action work?',
    options: [
  ...
  },
  {
    id: 'q5',
    type: 'multiple_choice',
    question: 'What is the main reason to keep a burner phone powered off and in airplane mode when not in use?',
    options: [
  ...
  },
  {
    id: 'q6',
    type: 'multiple_select',
    question: 'Which of the following is a good practice for protecting media shared from a burner phone?',
    options: [
  ...
  },
  {
    id: 'q7',
    type: 'multiple_choice',
    question: 'If a burner phone is seized by authorities, what assumption should you make?',
    options: [
  ...
  },
  {
    id: 'q8',
    type: 'multiple_choice',
    question: 'What is a red flag that a burner phone might draw unwanted attention?',
    options: [
