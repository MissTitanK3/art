...
export const digitalResilienceCommsQuestions: Question[] = [
  {
    ...
    question: 'What is the primary reason pods must train with contingency comms like mesh, LoRa, and radios?',
    options: [
  ...
  },
  {
    id: 'q4',
    type: 'multiple_choice',
    question: 'For LoRa/Meshtastic use, what is the recommended security measure for even benign messages?',
    options: [
  ...
  },
  {
    id: 'q5',
    type: 'true_false',
    question: 'Each pod should train only one tech operator on contingency comms tools to keep roles specialized.',
    correct: false,
  },
  {
    id: 'q6',
    type: 'multiple_choice',
    question: 'What is the correct message format for LoRa texts to keep them efficient?',
    options: [
  ...
  },
  {
    id: 'q7',
    type: 'multiple_select',
    question: 'What are standard radio fallback practices when networks are fully down?',
    options: [
  ...
  },
  {
    id: 'q8',
    type: 'multiple_choice',
    question: 'During a 6+ hour network blackout, which fallback method is recommended?',
    options: [
  ...
  },
  {
    id: 'q9',
    type: 'true_false',
    question: 'Carrying laminated frequency charts and code sheets is part of the recommended gear checklist.',
    correct: true,
  },
  {
    id: 'q10',
    type: 'multiple_select',
    question: 'Which security steps should pods include in their contingency comms audit?',
    options: [
