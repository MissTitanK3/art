...
export const solidarityEconomicsResourceEthicsQuestions: Question[] = [
  ...
  },
  {
    ...
    question: 'Which steps help build a transparent yet secure accounting system for pods?',
    options: [
  ...
  },
  {
    id: 'q4',
    type: 'multiple_choice',
    question: 'What is the first step pods should take before seeking external funding?',
    options: [
  ...
  },
  {
    id: 'q6',
    type: 'multiple_choice',
    question: 'According to the Funding Decision Flow, what should pods do when offered corporate funding?',
    options: [
  ...
  },
  {
    id: 'q7',
    type: 'multiple_select',
    question: 'What should shared infrastructure agreements between pods include?',
    options: [
  ...
  },
  {
    id: 'q8',
    type: 'multiple_choice',
    question: 'Which funding model provides local control and sustainability but takes longer to build?',
    options: [
  ...
  },
  {
    id: 'q10',
    type: 'multiple_select',
    question: 'Which practices help ensure autonomy and safety when funding pods?',
    options: [
