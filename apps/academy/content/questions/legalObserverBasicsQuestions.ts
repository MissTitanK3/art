...
export const legalObserverBasicsQuestions: Question[] = [
  ...
  },
  {
    id: 'lo-q2',
    type: 'true_false',
    question: 'Legal Observers may participate in chants as long as they document impartially.',
    correct: false,
  },
  {
    id: 'lo-q3',
  ...
  },
  {
    id: 'lo-q5',
    type: 'multiple_choice',
    question: 'When is it appropriate for a Legal Observer to speak directly to police?',
    options: [
  ...
  },
  {
    id: 'lo-q6',
    type: 'true_false',
    question: 'You should use ink pens, not pencil or erasable pens, when taking field notes.',
    correct: true,
  },
  {
    id: 'lo-q7',
    type: 'multiple_choice',
    question: 'If a dispersal order is issued, what should a Legal Observer do?',
    options: [
  ...
  },
  {
    id: 'lo-q8',
    type: 'multiple_choice',
    question: 'Why should Legal Observers avoid editing video footage before submission?',
    options: [
  ...
  },
  {
    id: 'lo-q10',
    type: 'multiple_choice',
    question: 'Why is peer support important for Legal Observers after an event?',
    options: [
