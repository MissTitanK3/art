...
export const lawEnforcementInteractionQuestions: Question[] = [
  {
    ...
    question: 'What should you say if ICE or police approach and you’re unsure of your status?',
    options: [
  ...
  },
  {
    id: 'le-q4',
    type: 'true_false',
    question: 'Remaining silent is legally safer than lying to law enforcement.',
    correct: true,
  },
  {
    id: 'le-q5',
  ...
  },
  {
    id: 'le-q9',
    type: 'multiple_choice',
    question: 'What is a grounding technique for dealing with panic during an encounter?',
    options: [
  ...
  },
  {
    id: 'le-q10',
    type: 'multiple_choice',
    question: 'Why should you avoid physically intervening during an ICE or police encounter?',
    options: [
  ...
  },
  {
    id: 'le-q12',
    type: 'multiple_choice',
    question: 'What is a safe and lawful script to say through a door during an ICE home visit?',
    options: [
      '“Come back later.”',
