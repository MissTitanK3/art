...
export const adminToolsQuestions: Question[] = [
  {
    ...
    question: 'What is one valid reason for manually creating a dispatch as an Admin?',
    options: [
  ...
  },
  {
    id: 'admin-q8',
    type: 'true_false',
    question: 'Admins should only use their access to support safety and clarity — not control.',
    correct: true,
  },
];
