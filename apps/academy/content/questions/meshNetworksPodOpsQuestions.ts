...
export const meshNetworksPodOpsQuestions: Question[] = [
  {
    ...
    question: 'Why is it important to create a new channel name and PSK (pre-shared key) for each mission?',
    options: [
  ...
  },
  {
    id: 'q2',
    type: 'true_false',
    question: 'A single relay node is usually enough to cover any size urban pod without backup.',
    correct: false,
  },
  {
    id: 'q3',
    type: 'multiple_select',
    question: 'Which devices are commonly used for pod-level Meshtastic networks?',
    options: [
  ...
  },
  {
    id: 'q4',
    type: 'multiple_choice',
    question: 'What is the recommended relay spacing in urban areas to maintain consistent coverage?',
  ...
  },
  {
    id: 'q5',
    type: 'true_false',
    question: 'It is best practice to share your pod’s encryption keys over public chat channels for convenience.',
    correct: false,
  },
  {
    id: 'q6',
    type: 'multiple_select',
    question: 'Which practices help keep a pod network powered during a long event?',
    options: [
