...
export const dealingWithChaosQuestions: Question[] = [
  {
    ...
    question: 'What is the most important action when a dispatch operation begins to collapse?',
    options: [
  ...
  },
  {
    id: 'chaos-q2',
    type: 'true_false',
    question: 'You should always believe what law enforcement tells you during a dispatch.',
    correct: false,
  },
  {
    id: 'chaos-q3',
  ...
  },
  {
    ...
    question: 'What are some key steps in the Rapid Reassessment Protocol (RRP)?',
    options: [
      'Pause and zoom out',
  ...
  },
  {
    id: 'chaos-q5',
    type: 'true_false',
    question: 'It is ethical to end a dispatch if the conditions on the ground become unsafe or unclear.',
    correct: true,
  },
  {
    id: 'chaos-q6',
