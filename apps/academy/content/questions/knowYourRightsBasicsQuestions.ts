...
export const knowYourRightsBasicsQuestions: Question[] = [
  {
    id: 'kyr-q1',
    type: 'true_false',
    question: 'Everyone in the U.S., regardless of immigration status, has constitutional rights.',
    correct: true,
  },
  {
    id: 'kyr-q2',
    type: 'multiple_choice',
    question: 'What kind of warrant must ICE present to enter your home without permission?',
    options: ['Verbal warrant from any agent', 'Administrative ICE warrant', 'Judicial warrant signed by a judge'],
    correct: 2,
  },
  {
    id: 'kyr-q3',
    type: 'multiple_select',
    question: 'Which of the following are rights you can assert during an encounter?',
    options: [
  ...
  },
  {
    id: 'kyr-q4',
    type: 'multiple_choice',
    question: 'If law enforcement tries to search your bag without probable cause, what should you say?',
    options: ['“It’s okay, just be quick.”', '“I do not consent to a search.”', '“I’m not hiding anything.”'],
    correct: 1,
  },
  {
    id: 'kyr-q5',
    type: 'true_false',
    question: 'An administrative warrant gives ICE legal authority to enter your home by force.',
    correct: false,
  },
  {
    id: 'kyr-q6',
    type: 'multiple_choice',
    question: 'What should you do if ICE or police knock on your door without a signed judicial warrant?',
    options: ['Open the door and ask why they’re there', 'Ignore it completely', 'Say: “I do not consent to entry.”'],
    correct: 2,
  },
  {
    id: 'kyr-q7',
  ...
  },
  {
    id: 'kyr-q8',
    type: 'true_false',
    question: 'If you are undocumented, you still have the right to remain silent.',
    correct: true,
  },
  {
    id: 'kyr-q9',
