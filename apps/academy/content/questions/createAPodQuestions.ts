...
export const createAPodQuestions: Question[] = [
  {
    ...
    question: 'What is the primary purpose of a pod within the ICE Tea network?',
    options: [
  ...
  },
  {
    id: 'q2',
    type: 'true_false',
    question: 'Pods must register with ICE Tea and follow strict central directives to be recognized.',
    correct: false,
  },
  {
    id: 'q3',
  ...
  },
  {
    id: 'q6',
    type: 'multiple_choice',
    question: 'What is the recommended disappearing message time range for a new Signal group?',
  ...
  },
  {
    id: 'q9',
    type: 'true_false',
    question: 'Pods are encouraged to use centralized control to ensure quick decisions across regions.',
    correct: false,
  },
  {
    id: 'q10',
    type: 'multiple_select',
    question: 'Which tools and practices help keep pod operations secure and effective?',
    options: [
