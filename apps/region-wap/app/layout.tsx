...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website",
    url: "/",
    siteName: "ART. Region WAP",
    title: "ART. Region WAP",
    description:
      "Siloed regional operations with cross‑region metadata only.",
    images: [{ url: "/og.png", width: 1200, height: 630, alt: "ART. Region WAP" }],
  },
  twitter: {
