...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website",
    url: "/",
    siteName: "ART. Region NORCAL",
    title: "ART. Region NORCAL",
    description:
      "Siloed regional operations with cross‑region metadata only.",
    images: [{ url: "/og.png", width: 1200, height: 630, alt: "ART. Region NORCAL" }],
  },
  twitter: {
