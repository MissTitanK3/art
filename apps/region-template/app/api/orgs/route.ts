...
export async function GET() {
    try {
        if (isDemoMode()) {
            // Provide a deterministic demo payload so /organizations always has content.
            const demoOrgId = "demo-org-1";
            const demoPodId = "demo-pod-1";
            return NextResponse.json({
                pods: [
                    { id: demoPodId, name: "Demo Pod Alpha", slug: "demo-pod-1", area: "Central" },
                    { id: "demo-pod-2", name: "Demo Pod Beta", slug: "demo-pod-2", area: "North" },
                ],
                orgRoles: [
                    {
                        role: "owner",
                        org_id: demoOrgId,
                        organization: { id: demoOrgId, name: "Demo Organization", description: "Demo organization for template" },
                    },
                ],
                orgPods: [
                    {
                        ...
                        pod_id: demoPodId,
                        organization: { id: demoOrgId, name: "Demo Organization", description: "Demo organization for template" },
                        pod: { id: demoPodId, name: "Demo Pod Alpha", slug: "demo-pod-1", area: "Central" },
                    },
                ],
                organizations: [
                    {
