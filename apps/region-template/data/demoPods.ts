...
const picardRoster = makeRosterEntry(
  ...
  [
    { id: 'starfleet-command', display_name: 'Starfleet Command Qualification', level: 'mentor' },
    { id: 'diplomatic-corps', display_name: 'Diplomatic Corps Liaison', level: 'completed' },
  ],
...
const rikerRoster = makeRosterEntry(
  ...
  [
    { id: 'command-track', display_name: 'Command Track Advanced', level: 'completed' },
    { id: 'helm-cert', display_name: 'Starfleet Helm Certification', level: 'completed' },
  ],
...
const dataRoster = makeRosterEntry(
  ...
  [
    ...
    { tag: 'x-android', display_name: 'Machine Code Interfaces', proficiency: 'native' },
  ],
  ['computational analysis', 'operations management', 'emergency response tracking'],
  [
    { id: 'operations-diagnostic', display_name: 'Operations Diagnostic Lead', level: 'mentor' },
    { id: 'universal-translator', display_name: 'Universal Translator Specialist', level: 'completed' },
  ],
...
const worfRoster = makeRosterEntry(
  ...
  [
    { id: 'starfleet-security', display_name: 'Starfleet Security Instructor', level: 'mentor' },
    { id: 'hand-to-hand', display_name: 'Advanced Hand-to-Hand Combat', level: 'completed' },
  ],
...
const laforgeRoster = makeRosterEntry(
  ...
  [
    { tag: 'en', display_name: 'Federation Standard', proficiency: 'native' },
    { tag: 'x-engineering', display_name: 'Warp Systems Diagnostics', proficiency: 'fluent' },
  ],
  ['warp systems', 'engineering triage', 'systems redundancy planning'],
  [
    { id: 'warp-core-safety', display_name: 'Warp Core Safety Officer', level: 'mentor' },
    { id: 'damage-control', display_name: 'Starfleet Damage Control', level: 'completed' },
  ],
...
const crusherRoster = makeRosterEntry(
  ...
  [
    { tag: 'en', display_name: 'Federation Standard', proficiency: 'native' },
    { tag: 'x-medical', display_name: 'Federation Medical Lexicon', proficiency: 'fluent' },
  ],
  ['trauma response', 'medical command', 'biohazard containment'],
  [
    { id: 'medical-director', display_name: 'Starfleet Medical Director', level: 'mentor' },
    { id: 'xeno-medicine', display_name: 'Xeno-Medicine Fellowship', level: 'completed' },
  ],
...
const troiRoster = makeRosterEntry(
  ...
  [
    { id: 'psionic-safety', display_name: 'Psionic Safety Counselor', level: 'completed' },
    { id: 'critical-incident', display_name: 'Critical Incident Response', level: 'completed' },
  ],
...
export const demoPods: Pod[] = [
  {
    ...
    channels: [
      ...
      { type: 'Matrix', link: 'https://matrix.lcars/#/starfleet/enterprise/bridge' },
    ],
  ...
  },
  {
    ...
    channels: [{ type: 'Matrix', link: 'https://matrix.lcars/#/starfleet/enterprise/engineering' }],
