...
export const ShipRenderer: React.FC<ShipRendererProps> = ({
  ...
  return (
    ...
    >
      ...
      {visuals.engine_positions.filter(p => !p.layer || p.layer === 'bottom').map((pos, index) => (
        <div 
      ...
      {visuals.engine_positions.filter(p => p.layer === 'top').map((pos, index) => (
        <div 
      ...
      {shipData.base_slots?.weapon_primary && visuals.weapon_mounts.primary && (
        ...
        >
            ...
            <div className="relative">
                {(() => {
                    const weaponSrc = getSlotAsset("weapon_primary", shipData.base_slots.weapon_primary);
                    if (weaponSrc) {
                        return (
                            <Image 
                                src={weaponSrc}
