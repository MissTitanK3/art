...
<Mermaid chart={`
graph TB
    A[Stress Signs Noticed]:::nodeStyle --> B{Is it You or Someone Else?}:::nodeStyle
    B -->|Self| C[Apply Grounding Technique]:::nodeStyle
    B -->|Other| D[Offer Support Check-In]:::nodeStyle
    C --> E[Reassess in 2 Minutes]:::nodeStyle
    D --> F[Escalate to Dispatcher or Care Lead if Needed]:::nodeStyle
    E -->|Improved| G[Continue Working]:::nodeStyle
    E -->|Worsening| H[Step Back or Activate Backup]:::nodeStyle
