...
<Callout type="info">
A **Community Defense Center (CDC)** is a mobile mutual aid node you can deploy anywhere — street corners, protests, food drops, or community events. It brings together ICE Tea Tools, public outreach, and direct safety support into one visible, actionable space.
...
<Callout type="hint">
Use a badge or patch so people know you’re with ICE Tea Tools — builds trust and invites conversation.
</Callout>
