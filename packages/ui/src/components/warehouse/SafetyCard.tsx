    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Hard constraints for the decentralized network.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
                {rules.map((rule) => (
                    <div key={rule.title} className="flex items-start gap-3 rounded-lg border p-3">
