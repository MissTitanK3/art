            ...
            <div className="grid gap-6 lg:grid-cols-[2.2fr_1fr]">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            4-step flow: context → zones → bins → admin notes. Set the steward you are
                            configuring for — currently <span className="font-semibold">{stewardLabel}</span>.
                        </CardDescription>
                    </CardHeader>
                        ...
                        <div className="flex flex-col gap-3 rounded-lg border bg-muted/40 p-3 md:flex-row md:items-center md:justify-between">
                            ...
                            <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        <SelectItem value={NEW_WAREHOUSE_VALUE}>New warehouse</SelectItem>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    <Button type="button" variant="outline" onClick={startNewWarehouse}>
                                        Start new
                                    </Button>
                                    {stewardName ? (
                                        <Button type="button" variant="ghost" onClick={useMyNameForSteward}>
                                            Use my display name
                                        </Button>
                                    ) : null}
                                </div>
                        ...
                        <Form {...form}>
                            ...
                            >
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    Appears on pick lists and movement logs. Type any steward’s display
                                                    name or use the shortcut above if you are the steward.
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>Matches dispatcher routing map.</FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    />
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>Helps dispatch estimate travel time.</FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    />
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>High-level load tolerance (no square footage).</FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    />
                                        ...
                                        <FormItem>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {capabilityOptions.map((capability) => {
                                                    const active = field.value?.includes(capability.value);
                                                    return (
                                                        <Button
                                                            ...
                                                            onClick={() => {
                                                                if (!field.value) {
                                                                    ...
                                                                    field.onChange(
                                                                        field.value.filter((val) => val !== capability.value),
                                                                    );
                                                                } else {
                                            ...
                                            <FormDescription>
                                                Toggle only what stewards can actually support in the next 48h.
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <section className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground">
                                                Keep zones under five and bins actionable. Sort order matches the pull path.
                                            </p>
                                        </div>
                                        <Button
                                            type="button"
                                            ...
                                            onClick={() =>
                                                appendZone({
                                                    ...
                                                    bins: [
                                                        { id: crypto.randomUUID(), label: "Shelf A", sortOrder: 1 },
                                                        { id: crypto.randomUUID(), label: "Tote 1", sortOrder: 2 },
                                                    ],
                                                })
                                            }
                                        >
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormDescription>
                                                Only Admin Dispatchers see these notes. Volunteers only see generated pull instructions.
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <div className="flex justify-end gap-3">
                                    ...
                                    <Button type="submit" disabled={!form.formState.isValid || syncing}>
                                        {syncing ? "Syncing…" : "Save warehouse"}
                                    </Button>
                                </div>
                            </form>
