...
import { FormField, FormItem, FormLabel, FormControl, FormMessage, FormDescription } from "@workspace/ui/components/form";
    ...
    return (
        <Card className="border-dashed">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
                <CardTitle className="text-base font-semibold">Zone {index + 1}</CardTitle>
            ...
            <CardContent className="space-y-4">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormDescription>Matches the steward’s pull path.</FormDescription>
                                <FormMessage />
                            </FormItem>
                        )}
                    />
                ...
                <div className="space-y-3">
                    ...
                    <Button
                        ...
                        size="sm"
                        onClick={() =>
                            appendBin({ id: generateId(), label: `Bin ${binFields.length + 1}` })
                        }
                    >
                        Add bin
                    </Button>
