  ...
  const submitCreate = async () => {
    ...
    await onCreateTeam?.({
      ...
      default_check_in_interval_minutes:
        createForm.default_check_in_interval_minutes ?? undefined,
    } as any);
          ...
          <div className="grid gap-2">
            ...
            <div className="grid gap-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setCreateForm((s) => ({ ...s, channel: e.target.value }))
                }
              />
            </div>
            <div className="grid gap-1">
              ...
              <Input
                id="team-location-label"
                value={(createForm as any).location_label ?? ""}
                onChange={(e) =>
                  setCreateForm((s) => ({
                    ...s,
            ...
            <div className="grid gap-1">
              ...
              <Select
                value={(createForm as any).encryption_mode ?? ""}
                onValueChange={(v) =>
                  setCreateForm((s) => ({ ...s, encryption_mode: v as any }))
                }
              >
            ...
            <div className="grid gap-1">
              ...
              <Input
                ...
                type="number"
                min={5}
                value={createForm.default_check_in_interval_minutes ?? ""}
                onChange={(e) =>
                  setCreateForm((s) => ({
                    ...s,
                    default_check_in_interval_minutes: e.target.value
                ...
                <div className="grid gap-2">
                  ...
                  <div className="grid gap-1">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setEditForm((s) => ({ ...s, channel: e.target.value }))
                      }
                    />
                  </div>
                  <div className="grid gap-1">
                    ...
                    <Input
                      value={(editForm as any).location_label ?? ""}
                      onChange={(e) =>
                        setEditForm((s) => ({
                          ...s,
                          location_label: e.target.value,
                  ...
                  <div className="grid gap-1">
                    <Label>Encryption</Label>
                    <Select
                      value={(editForm as any).encryption_mode ?? ""}
                      onValueChange={(v) =>
                        setEditForm((s) => ({
                          ...s,
                          encryption_mode: v as any,
                        }))
                      }
                    >
                      <SelectTrigger className="w-full">
                  ...
                  <div className="grid gap-1">
                    ...
                    <Input
                      type="number"
                      min={5}
                      value={editForm.default_check_in_interval_minutes ?? ""}
                      onChange={(e) =>
                        setEditForm((s) => ({
                          ...s,
                          default_check_in_interval_minutes: e.target.value
