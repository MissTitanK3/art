...
export default function MyProfileMapGuide() {
  return (
    <section className="prose dark:prose-invert max-w-none">
      ...
      <p>
        Select your operating counties and mark partial coverage zones. Dispatchers use this to
        understand where you can respond or coordinate. Changes save back to your profile.
      </p>
      ...
      <ul>
        ...
        <li>Selected counties appear below with actions to Edit Zones or Remove.</li>
      ...
      <ul>
        ...
        <li>Zoom to 7+ to edit; click grid cells to mark areas you can cover.</li>
      ...
      <ul>
        <li>
          Selections save to your profile’s operating counties (FIPS codes) and sync to the region
          database when configured.
        </li>
        <li>Map uses US county boundaries; a loading message appears while data hydrates.</li>
      </ul>

      <h3>Tips</h3>
      <ul>
        <li>Pick the counties you can regularly respond in; use zones for partial coverage.</li>
