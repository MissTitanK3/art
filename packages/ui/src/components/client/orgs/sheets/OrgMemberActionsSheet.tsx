...
import type { OrgMember, OrgRegisteredUser, OrgRoleOption } from "../types";
...
export function OrgMemberActionsSheet({
  ...
  const [selectedRole, setSelectedRole] = useState<string>(() => getDefaultRole(roles));
  ...
  }, [addMode, member, open, roles]);

  const selectedUser = registeredUsers.find((user) => user.id === selectedProfileId);
            ...
            <>
              <div className="grid gap-2">
                ...
                {selectedUser && (
                  <div className="text-xs text-muted-foreground">
                    Selected: <span className="font-medium text-foreground">{selectedUser.displayName}</span>
                  </div>
                )}
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  disabled={saving || !registeredUsers.length || !selectedProfileId}
                >
            ...
            <>
              <div className="flex items-center justify-between rounded-md border p-3">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Member information is limited to display names to keep PII safe.
                  </p>
                </div>
