...
import type { OrgPod } from "../types";
import { SheetDescription, SheetHeader, SheetTitle } from "@workspace/ui/components/sheet";
      ...
      <DrawerContent className="bg-card text-card-foreground max-w-2xl mx-auto overflow-y-auto">
        ...
        <DrawerFooter className="px-4">
          <div className="flex w-full justify-end gap-2">
            ...
            <Button onClick={handleLink} disabled={saving || options.length === 0}>
