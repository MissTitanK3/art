      ...
      <div className="flex flex-wrap gap-2">
        {options.map((option) => {
          ...
          return (
            ...
            >
              <span className="text-left">{option.label || formatNormLabel(option.value)}</span>
        ...
        {options.map((option) => {
          ...
          return (
            <div
              ...
              className={`rounded-md border p-2 text-xs leading-relaxed ${active ? "border-primary/60 bg-primary/5" : "border-border"
                }`}
            >
              <div className="font-medium">{option.label || formatNormLabel(option.value)}</div>
