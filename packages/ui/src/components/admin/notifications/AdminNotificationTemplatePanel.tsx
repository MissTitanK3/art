...
import type { SendArgs } from "./AdminNotificationForm";
...
export function AdminNotificationTemplatePanel({
  ...
  const [selectedTemplate, setSelectedTemplate] = React.useState<
    AdminNotificationTemplateKey | null
  >(null);
  ...
  const [draftLevel, setDraftLevel] = React.useState<NotificationLevel>(
    "info",
  );
  const [draftChannel, setDraftChannel] = React.useState<NotificationChannel>(
    "system",
  );
  ...
  }, [draftBody, draftChannel, draftLevel, draftLink, draftTitle, onSend, selectedOption]);
