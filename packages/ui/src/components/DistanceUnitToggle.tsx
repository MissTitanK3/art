...
export function DistanceUnitToggle({ size = 'sm', variant = 'light', className, showLabel = true }: DistanceUnitToggleProps) {
  ...
  return (
    <Button aria-label={nextHint} title={nextHint} size={size} variant={variant} onClick={toggle} className={className}>
