...
export const modalityLabels: Record<
  AcademyTrainingSession["modality"],
  string
> = {
  in_person: "In Person",
  online: "Online",
...
export const instructorTypeLabels: Record<
  AcademyInstructorProfile["type"],
  string
> = {
...
export const availabilityLabels: Record<
  AcademyInstructorProfile["availability"],
  string
> = {
  available: "Available",
  limited: "Limited",
...
export const instructorRegistrationLabels: Record<
  AcademyInstructorRegistrationStatus,
  string
> = {
  registered: "Registered",
  unregistered: "Guest SME",
  pending: "Pending Intake",
};

export const instructorVettingLabels: Record<
  AcademyInstructorVettingStatus,
  string
> = {
...
export const instructorVettingMessages: Record<
  AcademyInstructorVettingStatus,
  string
> = {
...
export const instructorVettingClasses: Record<
  AcademyInstructorVettingStatus,
  string
> = {
