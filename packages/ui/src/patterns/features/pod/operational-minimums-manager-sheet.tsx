...
function toDraft(definition: RegionOperationalMinimumDefinition): DraftMinimum {
  ...
  return {
    ...
    staffingMax:
      typeof max === "number" && !Number.isNaN(max) ? String(max) : "",
...
function draftToDefinition(
  ...
  const emphasis =
    draft.emphasis.trim().length > 0 ? draft.emphasis.trim() : undefined;
...
export function OperationalMinimumsManagerSheet({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="right"
        className="flex max-w-3xl flex-col bg-card text-card-foreground p-0"
      >
        <SheetHeader className="border-b border-border/70 px-6 py-5">
          <SheetTitle>Manage Operational Minimums</SheetTitle>
          <SheetDescription>
            Adjust staffing targets, required courses, and emphasis notes for
            each competency. Changes apply to the current region once saved.
          </SheetDescription>
        </SheetHeader>
        ...
        <ScrollArea className="flex-1 px-6 py-5">
          <div className="space-y-6 pb-6">
              ...
              >
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    <Label htmlFor={`${draft.key}-required-count`}>
                      Ready headcount
                    </Label>
                    <Input
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="space-y-2">
                      <Label htmlFor={`${draft.key}-staffing-min`}>
                        Staffing min
                      </Label>
                      <Input
                    ...
                    <div className="space-y-2">
                      <Label htmlFor={`${draft.key}-staffing-max`}>
                        Staffing max
                      </Label>
                      <Input
                ...
                <div className="space-y-3">
                  ...
                  {draft.requiredCourses.length > 0 ? (
                    ...
                    <p className="text-sm text-muted-foreground">
                      No courses selected yet. Toggle chips below or add a
                      custom slug.
                    </p>
                  )}
                  ...
                  <div className="space-y-2">
                    ...
                    {courseOptions.length > 0 ? (
                        ...
                        {courseOptions.map((option) => {
                          ...
                          return (
                            <Button
                              ...
                              onClick={() =>
                                handleCourseToggle(index, option.id)
                              }
                      ...
                      <p className="text-sm text-muted-foreground">
                        No course blueprint entries available. Use the custom
                        slug field instead.
                      </p>
                    )}
                  </div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Toggle chips to require academy courses, or add custom
                    certification slugs manually. Selected courses appear above;
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    value={draft.tags}
                    onChange={(event) =>
                      handleFieldChange(index, "tags", event.target.value)
                    }
                ...
                <div className="space-y-2">
                  <Label htmlFor={`${draft.key}-description`}>
                    Description
                  </Label>
                  <Textarea
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(event) =>
                      handleFieldChange(index, "emphasis", event.target.value)
                    }
            ...
            {drafts.length === 0 ? (
              <p className="text-sm text-muted-foreground">
                No operational minimums available yet. Add definitions in
