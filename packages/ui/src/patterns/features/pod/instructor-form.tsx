...
import {
  ...
  createCertification,
} from "@workspace/ui/lib/academy-utils";
  ...
  function InstructorForm({ initial = {}, onSubmit }, ref) {
    ...
    function handleSubmit(e: React.FormEvent) {
      ...
      if (!name.trim() || !focus.trim()) {
        console.debug("InstructorForm: validation failed", {
          name: name.trim(),
          focus: focus.trim(),
        });
        return;
    ...
    return (
      <form ref={formRef} className="space-y-4" onSubmit={handleSubmit}>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(v) => setRegistrationStatus(v as any)}
            >
        ...
        <div className="space-y-2">
          ...
          <Select
            value={vettingStatus}
            onValueChange={(v) => setVettingStatus(v as any)}
          >
        ...
        <div className="space-y-3">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-xs text-muted-foreground">
              Add from the Academy catalog or enter a custom skill.
            </p>
          </div>
          <Select
            value={undefined}
