...
import { OrgPodsPanel } from "@workspace/ui/patterns/features/panels/org-pods-panel";
import { OrgMembersPanel } from "@workspace/ui/patterns/features/panels/org-members-panel";
import { OrgPollsPanel } from "@workspace/ui/patterns/features/panels/org-polls-panel";
import { OrgEditSheet } from "@workspace/ui/patterns/features/sheets/org-edit-sheet";
import { OrgLinkPodSheet } from "@workspace/ui/patterns/features/sheets/org-link-pod-sheet";
import { OrgTransferOwnershipSheet } from "@workspace/ui/patterns/features/sheets/org-transfer-ownership-sheet";
import { OrgMemberActionsSheet } from "@workspace/ui/patterns/features/sheets/org-member-actions-sheet";
import { OrgNormsOverviewCard } from "@workspace/ui/patterns/features/orgs/org-norms-overview-card";
import { OrgNormsEditorSheet } from "@workspace/ui/patterns/features/orgs/org-norms-editor-sheet";
...
export function OrgDashboardDrawer({
  ...
  const [activeTab, setActiveTab] = useState<OrgTabKey>(
    normalizeTabKey(initialTab)
  );
    ...
    const visibilityCard = (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Choose who can see this organization’s details. Invite people if you
      ...
      <div className="grid gap-3">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Update details and ownership. Shared components stay
              region-agnostic and depend on the callbacks provided by the region
              app.
            </CardDescription>
          </CardHeader>
  ...
  const teamPanel = (
    <div className="grid gap-4">
      ...
      <OrgMembersPanel
        ...
        permissions={permissions}
        onAddMember={
          permissions?.canManageMembers ? openAddMemberSheet : undefined
        }
