...
import { OrgNormsSection } from "./org-norms-section";
...
const SECTIONS: NormSection[] = [
  ...
  },
  {
    ...
    title: "Safety level",
    description:
      "Expected risk level and baseline safety readiness for members.",
  },
  {
    key: "communication",
    title: "Communication",
...
export function OrgNormsEditorSheet({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="right"
        className="w-full max-w-3xl overflow-hidden bg-card text-card-foreground z-[1200]"
      >
        <SheetHeader>
          <SheetTitle>Edit organizational norms</SheetTitle>
          <SheetDescription>
            Align on decision-making, communication, conflict resolution, and
            safety practices. These norms are visible to everyone in the org
            overview.
          </SheetDescription>
        </SheetHeader>
