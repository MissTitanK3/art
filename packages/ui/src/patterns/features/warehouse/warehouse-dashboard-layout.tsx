...
import { StatCard } from "@workspace/ui/patterns/features/warehouse/stat-card";
import { InventorySnapshotCard } from "@workspace/ui/patterns/features/warehouse/inventory-snapshot-card";
import { MovementLogCard } from "@workspace/ui/patterns/features/warehouse/movement-log-card";
import { PickListBuilderCard } from "@workspace/ui/patterns/features/warehouse/pick-list-builder-card";
import { SavedWarehousesList } from "@workspace/ui/patterns/features/warehouse/saved-warehouses-list";
import { InventoryIntakeForm } from "@workspace/ui/patterns/features/warehouse/inventory-intake-form";
import { ConfirmedPickListsCard } from "@workspace/ui/patterns/features/warehouse/confirmed-pick-lists-card";
import {
    ...
    <div className="space-y-8 py-8">
      ...
      {!profileDisplayName ? (
        <Alert variant="destructive">
          ...
          <AlertDescription>
            Add a display name to your profile so the warehouse can be tied to a
            steward.
          </AlertDescription>
        </Alert>
      ) : null}
      ...
      <Sheet open={isIntakeSheetOpen} onOpenChange={onIntakeSheetOpenChange}>
        <SheetContent
          side="right"
          className="overflow-y-auto bg-card text-card-foreground p-4"
        >
          <SheetHeader>
            <SheetTitle>Inventory Intake</SheetTitle>
            <SheetDescription>
              Search or create an item, place it in a zone/bin, and write the
              movement log.
            </SheetDescription>
          </SheetHeader>
          <div className="mt-6">
