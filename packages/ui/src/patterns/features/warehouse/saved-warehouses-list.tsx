...
import {
  VisibilityChip,
  VisibilitySelector,
} from "@workspace/ui/patterns/features/permissions/visibility-selector";
...
export function SavedWarehousesList({
  warehouses,
  onWarehouseUpdate,
}: SavedWarehousesListProps) {
            ...
            <Card key={warehouse.id} className="flex flex-col">
              <CardHeader className="space-y-1">
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="grid gap-3 md:grid-cols-2">
                              ...
                              <div className="space-y-2">
                                ...
                                <Input
                                  value={
                                    editingWarehouse.stewardDisplayName ?? ""
                                  }
                                  onChange={(e) =>
                                    setEditingWarehouse({
                                      ...editingWarehouse,
                              ...
                              <div className="space-y-2 md:col-span-2">
                                ...
                                <VisibilitySelector
                                  value={
                                    (editingWarehouse.visibilityScope ??
                                      "regional") as VisibilityScope
                                  }
                                  onChange={(scope) =>
                                    setEditingWarehouse({
                                      ...editingWarehouse,
                ...
                <CardDescription className="flex items-center gap-2">
                  <VisibilityChip
                    scope={
                      (warehouse.visibilityScope ||
                        "regional") as VisibilityScope
                    }
                  />
                  {
                    capacityOptions.find(
                      (opt) => opt.value === warehouse.maxCapacityRating
                    )?.label
                  }{" "}
                  Warehouse
                </CardDescription>
