...
<Mermaid chart={`
graph TB
    A[Suspicious Presence Noticed]:::nodeStyle --> B{Physical or Digital?}:::nodeStyle
    B -->|Physical| C[Document Patterns & Plates]:::nodeStyle
    B -->|Digital| D[Preserve Screenshots & Metadata]:::nodeStyle
    C --> E[Review with Security Lead/Pod Council]:::nodeStyle
    D --> F[Isolate from Sensitive Comms]:::nodeStyle
    E --> G[Determine Escalation Level]:::nodeStyle
