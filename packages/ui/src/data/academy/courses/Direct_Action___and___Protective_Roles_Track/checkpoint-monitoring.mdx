...
<Callout type="hint">
Review <a href="/courses/kyr-basics">Know Your Rights (KYR) Basics</a> and <a href="/courses/documentation-safety">Documentation Safety</a> before monitoring. If using the ART Watch tools, also see <a href="/courses/art-watch">Community Watch (ART Watch)</a>.
</Callout>
...
<Callout type="info">
For device hardening and safer sharing, review <a href="/courses/digital-security-basics">Digital Security Basics</a>.
</Callout>
...
<Callout type="hint">
Language access saves time at checkpoints. If interpretation is needed, see <a href="/courses/translator-micro-badge">Translator Micro‑badge</a> and <a href="/courses/asl-interpreter-micro-badge">ASL Interpreter Micro‑badge</a>.
</Callout>
...
<Callout type="info">
If you’re tied into a local dispatch workflow, follow your region’s reporting guide (see <a href="/courses/responding-to-dispatch-calls">Responding to Dispatch Calls</a>). For sensitive footage handling, see <a href="/courses/after-action-data-hygiene">After‑Action Data Hygiene</a>.
</Callout>

<Callout type="hint">
If the monitoring captured detentions or other legal concerns, coordinate with <a href="/courses/court-support">Court Support</a> and <a href="/courses/legal-followthrough-jail-support">Legal Follow‑through & Jail Support</a> for next steps.
</Callout>
