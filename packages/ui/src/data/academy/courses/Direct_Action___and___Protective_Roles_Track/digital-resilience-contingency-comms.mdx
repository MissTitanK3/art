...
<Callout type="hint">
Pre‑wire your fallback stack and roles with <a href="/courses/mesh-networks-intro">Mesh Networks Intro</a>, <a href="/courses/app-free-tactics">App‑Free Tactics</a>, and <a href="/courses/comms-collapse">Comms Collapse</a>. For device hardening, see <a href="/courses/digital-security-basics">Digital Security Basics</a> and <a href="/courses/burner-phones-security-culture">Burner Phones & Security Culture</a>.
</Callout>
...
<Callout type="hint">
If movement is required during blackout drills, plan handoffs and transport with <a href="/courses/runners-and-rides">Runners & Rides</a> and your region’s <a href="/courses/responding-to-dispatch-calls">Responding to Dispatch Calls</a> norms.
</Callout>
...
<Callout type="info">
When you must log anything, follow <a href="/courses/documentation-safety">Documentation Safety</a> and clean retention per <a href="/courses/after-action-data-hygiene">After‑Action Data Hygiene</a>.
</Callout>
