...
<Callout type="hint">
Pair this with <strong><a href="/academy/dispatch-coordination">Dispatch Coordination</a></strong> to align logistics decisions with active dispatches and avoid duplication.
</Callout>
...
3. Build a **driver roster with backups** (day and night, multiple vehicle types).  
  → See <a href="/academy/runners-and-rides">Runners &amp; Rides</a> for transport playbooks.
4. Use **offline logs + encrypted backups** (e.g., paper plus Tella or VeraCrypt) to avoid data loss.  
  → See <a href="/academy/documentation-safety">Documentation Safety</a> and <a href="/academy/digital-security-basics">Digital Security Basics</a>.
...
- Assign **zone leads** responsible for rotation and inspection (coordinate with <a href="/academy/dispatch-coordination">Dispatch Coordination</a>)
...
Related: <a href="/academy/runners-and-rides">Runners &amp; Rides</a>
...
- **Mesh comms:** Bridgefy for blackout transport coordination  
  → Learn more: <a href="/academy/mesh-networks-intro">Mesh Networks Intro</a>, <a href="/academy/app-free-tactics">App‑Free Tactics</a>, <a href="/academy/comms-collapse">Comms Collapse</a>  
