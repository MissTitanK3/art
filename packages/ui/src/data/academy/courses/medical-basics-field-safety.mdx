...
<Mermaid chart={`
graph TD
    A[Injury Reported]:::nodeStyle --> B{Conscious?}:::nodeStyle
    B -->|No| C[Check Breathing]:::nodeStyle
    B -->|Yes| D[Assess Bleeding]:::nodeStyle
    C -->|Breathing| E[Recovery Position]:::nodeStyle
    C -->|Not Breathing| F[Start Hands-Only CPR]:::nodeStyle
    D -->|Severe Bleed| G[Apply Tourniquet or Pack Wound]:::nodeStyle
    D -->|Moderate Bleed| H[Apply Pressure Dressing]:::nodeStyle
    G --> I[Signal Medic & Document Care]:::nodeStyle
    H --> I
