...
export const howToReportQuestions: Question[] = [
  ...
  },
  {
    ...
    type: "true_false",
    question:
      "It’s okay to report what you heard from a friend even if you didn’t witness it yourself.",
    correct: false,
  },
  {
    id: "q3",
  ...
  },
  {
    ...
    type: "multiple_choice",
    question:
      "What should you do if it’s not safe to record during an ICE encounter?",
    options: [
