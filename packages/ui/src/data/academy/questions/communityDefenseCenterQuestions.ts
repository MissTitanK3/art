...
export const communityDefenseCenterQuestions: Question[] = [
  ...
  },
  {
    id: 'q2',
    type: 'true_false',
    question: 'A CDC can be deployed with just a backpack, some flyers, and QR codes.',
    correct: true,
  },
  {
    id: 'q3',
    type: 'multiple_choice',
    question: 'Which of the following roles is responsible for helping new people join the ICE Tea Academy?',
    options: ['Outreach Lead', 'Academy Coach', 'Tactical Coordinator', 'Safety Watcher'],
    correct: 1,
  },
  {
    id: 'q4',
  ...
  },
  {
    id: 'q5',
    type: 'true_false',
    question: 'You should destroy any contact info collected during a CDC once the event is over.',
    correct: false,
  },
  {
    id: 'q6',
  ...
  },
  {
    id: 'q7',
    type: 'multiple_choice',
    question: 'Which deployment method offers the most mobility for protests or street actions?',
    options: ['10x10 Tent Setup', 'Van Conversion', 'Cargo Bike or Cart', 'Solar Command Trailer'],
    correct: 2,
  },
  {
    id: 'q8',
  ...
  },
  {
    id: 'q9',
    type: 'true_false',
    question: 'CDC deployments always require a generator, scanner, and hotspot.',
    correct: false,
  },
  {
    id: 'q10',
