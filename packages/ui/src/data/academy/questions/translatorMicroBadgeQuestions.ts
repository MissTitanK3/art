...
export const translatorMicroBadgeQuestions: Question[] = [
  ...
  },
  {
    id: 'q2',
    type: 'true_false',
    question: 'Translators must pass both a fluency check and a stress-test before active field work.',
    correct: true,
  },
  {
    id: 'q3',
    type: 'multiple_select',
    question: 'Which practices ensure accurate and safe translation during actions?',
    options: [
  ...
  },
  {
    id: 'q5',
    type: 'true_false',
    question: 'Taking breaks after 30 minutes of intensive translation helps prevent errors due to fatigue.',
    correct: true,
  },
  {
    id: 'q6',
  ...
  },
  {
    id: 'q8',
    type: 'multiple_choice',
    question: 'How should translators respond if someone becomes overwhelmed during translation?',
    options: [
