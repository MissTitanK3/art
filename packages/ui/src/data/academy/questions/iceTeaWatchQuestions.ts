...
export const iceTeaWatchQuestions: Question[] = [
  ...
  },
  {
    ...
    question:
      "Which of the following are valid types of ICE Tea Watch reports?",
    options: [
  ...
  },
  {
    ...
    type: "true_false",
    question:
      "Sharing unverifiable secondhand reports can create confusion or fear.",
    correct: true,
  },
  {
    id: "q5",
  ...
  },
  {
    ...
    type: "true_false",
    question:
      "Photos you submit may include metadata like time and location unless removed.",
    correct: true,
  },
  {
    id: "q7",
  ...
  },
  {
    ...
    type: "multiple_choice",
    question:
      "What’s a safe action to take if you suspect ICE presence but can’t confirm?",
    options: [
  ...
  },
  {
    ...
    type: "multiple_choice",
    question:
      "Which platform allows you to report anonymously and without logging in?",
