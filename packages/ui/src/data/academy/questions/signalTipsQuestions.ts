...
export const signalTipsQuestions: Question[] = [
  ...
  },
  {
    id: 'q2',
    type: 'true_false',
    question: 'Signal automatically strips location and EXIF data from photos you send.',
    correct: true,
  },
  {
    id: 'q3',
    type: 'multiple_choice',
    question: 'What is the best way to register for Signal if you want to stay anonymous?',
    options: [
  ...
  },
  {
    id: 'q6',
    type: 'true_false',
    question: 'Signal groups automatically reveal every member’s phone number to each other.',
    correct: false,
  },
  {
    id: 'q7',
    type: 'multiple_choice',
    question: 'How can you send a mass alert without revealing everyone’s identity?',
    options: [
  ...
  },
  {
    id: 'q8',
    type: 'multiple_select',
    question: 'Which practices improve security for high-risk pods and dispatchers?',
    options: [
