...
export const encryption101Questions: Question[] = [
  ...
  },
  {
    ...
    type: "true_false",
    question:
      "If you forget the encryption passphrase, ICE Tea staff can recover it for you.",
    correct: false,
  },
  {
    id: "q3",
  ...
  },
  {
    ...
    type: "multiple_choice",
    question:
      "What’s the safest way to share an encryption passphrase with a dispatcher?",
    options: [
      "Email or group chat",
      "Text message or Instagram DM",
      "Secure app like Signal or in-person",
    ],
    correct: 2,
  },
  {
    ...
    type: "true_false",
    question:
      "All reports in ICE Tea are automatically end-to-end encrypted, even without a passphrase.",
    correct: false,
  },
  {
    id: "q7",
  ...
  },
  {
    ...
    type: "multiple_choice",
    question:
      "Why is it risky to share encrypted content publicly—even without the passphrase?",
    options: [
  ...
  },
  {
    ...
    type: "true_false",
    question:
      "Encryption protects the content of a message but not metadata like time or sender identity.",
    correct: true,
  },
  {
    id: "q11",
