...
export const mutualAidHistoryQuestions: Question[] = [
  ...
  },
  {
    id: 'ma-q5',
    type: 'multiple_choice',
    question: 'What did Peter Kropotkin argue in *Mutual Aid: A Factor of Evolution*?',
    options: [
  ...
  },
  {
    id: 'ma-q7',
    type: 'multiple_select',
    question: 'Why is security culture important in mutual aid work? (Select all that apply)',
    options: [
  ...
  },
  {
    id: 'ma-q8',
    type: 'multiple_choice',
    question: 'Which Indigenous tradition used ceremonies to redistribute wealth in a mutual aid practice?',
    options: [
