...
export const abolitionEthicsQuestions: Question[] = [
  ...
  },
  {
    id: 'q2',
    type: 'true_false',
    question: 'Abolition ethics believe violence can be a necessary form of justice.',
    correct: false,
  },
  {
    id: 'q3',
    type: 'multiple_select',
    question: 'Which of the following are examples of life-affirming alternatives to policing and prisons?',
    options: ['Healing circles', 'Crisis response teams', 'Deportation flights', 'Mutual aid networks'],
    correct: [0, 1, 3],
  },
  {
    id: 'q4',
  ...
  },
  {
    id: 'q5',
    type: 'multiple_choice',
    question: 'Why do abolitionists often oppose institutions like ICE, police, and prisons?',
    options: [
  ...
  },
  {
    id: 'q6',
    type: 'true_false',
    question: 'Accountability in abolitionist practice means punishing someone for the harm they caused.',
    correct: false,
  },
  {
    id: 'q7',
    type: 'multiple_choice',
    question: 'What does the quote “Abolition is about presence, not absence” mean?',
    options: [
  ...
  },
  {
    id: 'q8',
    type: 'multiple_choice',
    question: 'In abolitionist practice, what does “building in the negative” mean?',
    options: [
  ...
  },
  {
    id: 'q10',
    type: 'true_false',
    question: 'The ICE Tea ecosystem integrates abolitionist values into its design and operations.',
    correct: true,
  },
  {
    id: 'q11',
    type: 'multiple_choice',
    question: 'Which of the following is NOT a historical influence on modern abolition?',
    options: [
  ...
  },
  {
    id: 'q12',
    type: 'multiple_choice',
    question: 'What distinguishes transformative justice from punitive justice?',
    options: [
