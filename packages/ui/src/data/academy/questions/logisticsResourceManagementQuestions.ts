...
export const logisticsResourceManagementQuestions: Question[] = [
  {
    ...
    question: 'Why is strong logistics critical for pods during actions or emergencies?',
    options: [
  ...
  },
  {
    id: 'q2',
    type: 'true_false',
    question: 'Staging areas should have multiple exits and low visibility from roads or aerial surveillance.',
    correct: true,
  },
  {
    id: 'q3',
  ...
  },
  {
    id: 'q4',
    type: 'multiple_choice',
    question: 'How much water should be stocked per person per day, at minimum?',
  ...
  },
  {
    id: 'q6',
    type: 'multiple_choice',
    question: 'Which system helps avoid a single point of failure for logistics details?',
    options: [
  ...
  },
  {
    id: 'q8',
    type: 'multiple_choice',
    question: 'How often should perishable supplies be cycled out of staging areas?',
    options: ['Every 7–14 days', 'Once every 30 days', 'Only when supplies run out'],
    correct: 0,
  },
  {
    id: 'q9',
    type: 'true_false',
    question: 'Fallback caches should be waterproof, rodent-proof, and checked on a regular schedule.',
    correct: true,
  },
  {
    id: 'q10',
