...
export const runnersAndRidesQuestions: Question[] = [
  {
    ...
    question: 'When is it safest to use a runner instead of digital communication?',
    options: [
  ...
  },
  {
    id: 'rrides-q2',
    type: 'true_false',
    question: 'Rideshare drivers should always know the names of the people they are transporting.',
    correct: false,
  },
  {
    id: 'rrides-q3',
    type: 'multiple_select',
    question: 'Which of the following are valid reasons to cancel a planned ride or runner route?',
    options: [
  ...
  },
  {
    id: 'rrides-q7',
    type: 'multiple_choice',
    question: 'What is one method of confirming a successful handoff without exposing names or sensitive content?',
    options: [
