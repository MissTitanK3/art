...
export const meshNetworksHardwareQuestions: Question[] = [
  ...
  },
  {
    id: 'q2',
    type: 'true_false',
    question: 'A single 10,000 mAh battery pack can typically power a T-Beam for 12–24 hours.',
    correct: true,
  },
  {
    id: 'q3',
  ...
  },
  {
    id: 'q4',
    type: 'multiple_choice',
    question: 'What is the typical cost for a fully equipped 5–8 node pod, including power and one relay?',
  ...
  },
  {
    id: 'q5',
    type: 'true_false',
    question: 'Weatherproof cases and coded labeling help protect equipment and maintain security.',
    correct: true,
  },
  {
    id: 'q6',
    type: 'multiple_select',
    question: 'Which accessories are considered essential for pod-level operations?',
    options: [
