...
export const outreachMessagingCommunityTrustQuestions: Question[] = [
  {
    ...
    question: 'What is the correct order for structuring conversations with businesses and community members?',
    options: [
  ...
  },
  {
    ...
    question: 'Which items should every field team carry during outreach actions?',
    options: [
  ...
  },
  {
    id: 'q6',
    type: 'multiple_choice',
    question: 'What is the main purpose of the Bailout Protocol in this outreach context?',
    options: [
  ...
  },
  {
    id: 'q8',
    type: 'multiple_choice',
    question: 'Why is it important to keep the five-step conversation structure consistent across all team members?',
    options: [
  ...
  },
  {
    id: 'q10',
    type: 'multiple_select',
    question: 'Which best practices should field teams follow for effective and safe outreach?',
    options: [
