...
export const interPodRegionalCoordinationQuestions: Question[] = [
  {
    ...
    question: 'Why is inter-pod coordination critical for large-scale or multi-day events?',
    options: [
  ...
  },
  {
    id: 'q2',
    type: 'true_false',
    question: 'Pods should always skip verification steps when linking up during a crisis to save time.',
    correct: false,
  },
  {
    id: 'q3',
    type: 'multiple_select',
    question: 'What are key elements of a Reciprocal Agreement (MOU) between pods?',
    options: [
  ...
  },
  {
    id: 'q4',
    type: 'multiple_choice',
    question: 'Which method helps avoid extractive dynamics between larger and smaller pods?',
    options: [
  ...
  },
  {
    id: 'q5',
    type: 'true_false',
    question: 'Regional pod maps should have both encrypted digital copies and physical backups.',
    correct: true,
  },
  {
    id: 'q6',
    ...
    options: ['At least once per year', 'Every month', 'Only after a real crisis occurs'],
    correct: 0,
  },
  {
    id: 'q7',
  ...
  },
  {
    id: 'q8',
    type: 'multiple_choice',
    question: 'What is the main priority when load balancing volunteers and resources across pods?',
    options: [
  ...
  },
  {
    id: 'q9',
    type: 'true_false',
    question: 'Over-sharing information between pods can increase the risk of infiltration or surveillance.',
    correct: true,
  },
  {
    id: 'q10',
