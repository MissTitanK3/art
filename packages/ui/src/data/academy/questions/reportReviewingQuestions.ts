...
export const reportReviewingQuestions: Question[] = [
  ...
  },
  {
    ...
    question: 'Which of the following are valid reasons to reject a report during review?',
    options: [
  ...
  },
  {
    id: 'rr-q4',
    type: 'multiple_select',
    question: 'What information should you confirm when reviewing a valid report?',
    options: [
      'Specific location',
      'Timestamp accuracy',
  ...
  },
  {
    id: 'rr-q6',
    type: 'true_false',
    question: 'It is acceptable to share submitted media with other volunteers outside the review platform if urgent.',
    correct: false,
  },
  {
    id: 'rr-q7',
    type: 'multiple_choice',
    question: 'If you’re unsure about a report’s authenticity, what should you do before publishing?',
    options: [
  ...
  },
  {
    id: 'rr-q9',
    type: 'multiple_choice',
    question: 'A report includes a close-up image of a detainee’s face. What is the correct action?',
    options: [
