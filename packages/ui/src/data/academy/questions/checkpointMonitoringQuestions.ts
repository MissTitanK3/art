...
export const checkpointMonitoringQuestions: Question[] = [
  ...
  },
  {
    id: 'q2',
    type: 'true_false',
    question: 'It is legal to record law enforcement presence from a public sidewalk.',
    correct: true,
  },
  {
    id: 'q3',
  ...
  },
  {
    id: 'q4',
    type: 'multiple_choice',
    question: 'What should you say if an officer asks why you’re filming from a public space?',
    options: [
  ...
  },
  {
    id: 'q6',
    type: 'true_false',
    question: 'It’s safer to livestream checkpoint monitoring while you are still on-site.',
    correct: false,
  },
  {
    id: 'q7',
  ...
  },
  {
    id: 'q8',
    type: 'multiple_choice',
    question: 'Which of the following is a red flag during a checkpoint stop, and what should you do?',
    options: [
  ...
  },
  {
    id: 'q9',
    type: 'multiple_choice',
    question: 'How should you interact with drivers or pedestrians who ask for help?',
    options: [
  ...
  },
  {
    id: 'q11',
    type: 'true_false',
    question: 'Your buddy should always remain within eyesight during checkpoint monitoring.',
    correct: true,
  },
  {
    id: 'q12',
    type: 'multiple_choice',
    question: 'What’s one way to support a non-English speaker who asks you for help?',
    options: [
