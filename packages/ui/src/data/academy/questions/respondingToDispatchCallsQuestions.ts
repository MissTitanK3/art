...
export const respondingToDispatchCallsQuestions: Question[] = [
  {
    ...
    options: ['Instagram DMs', 'Email lists', 'Signal threads or dispatch apps', 'Public Telegram channels'],
    correct: 2,
  },
  {
    id: 'rdc-q2',
  ...
  },
  {
    id: 'rdc-q3',
    type: 'true_false',
    question: 'You should only respond to a call if you feel stable, prepared, and clear about your role.',
    correct: true,
  },
  {
    id: 'rdc-q4',
