...
export const aslInterpreterMicroBadgeQuestions: Question[] = [
  {
    ...
    question: 'What is the primary role of an ASL interpreter during field actions?',
    options: [
  ...
  },
  {
    id: 'q2',
    type: 'true_false',
    question: 'Interpreters should always wear bright, visible badges to ensure they are easy to identify.',
    correct: false,
  },
  {
    id: 'q3',
    type: 'multiple_select',
    question: 'Which of the following are recommended practices for interpreters in loud or low-light environments?',
    options: [
  ...
  },
  {
    id: 'q4',
    type: 'multiple_choice',
    question: 'What is the correct positioning for an interpreter during a street protest?',
    options: [
  ...
  },
  {
    id: 'q6',
    type: 'multiple_choice',
    question: 'Why is it important to pre-learn legal and crisis vocabulary in ASL?',
    options: [
  ...
  },
  {
    id: 'q7',
    type: 'multiple_select',
    question: 'Which hand signals should interpreters coordinate with field leads?',
    options: [
  ...
  },
  {
    id: 'q8',
    type: 'multiple_choice',
    question: 'What is the recommended interpreter rotation schedule to prevent fatigue?',
  ...
  },
  {
    id: 'q10',
    type: 'multiple_select',
    question: 'Which items are part of the recommended ASL interpreter field kit?',
    options: [
