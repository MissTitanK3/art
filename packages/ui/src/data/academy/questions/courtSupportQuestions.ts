...
export const courtSupportQuestions: Question[] = [
  {
    ...
    question:
      "What is the most important role of a court supporter during a hearing?",
    options: [
  ...
  },
  {
    ...
    type: "true_false",
    question:
      "You should always ask the person if they want you to attend court before showing up.",
    correct: true,
  },
  {
    id: "q3",
    ...
    question:
      "Which of the following actions are appropriate during a court hearing?",
    options: [
  ...
  },
  {
    ...
    type: "multiple_choice",
    question:
      "What’s one appropriate way to support someone having an emotional reaction after court?",
    options: [
  ...
  },
  {
    ...
    type: "true_false",
    question:
      "You can post about a person’s court hearing on social media as long as you’re showing support.",
    correct: false,
  },
  {
    id: "q7",
  ...
  },
  {
    ...
    type: "multiple_choice",
    question:
      "If you arrive and the courtroom is too full, what should you do?",
    options: [
  ...
  },
  {
    ...
    type: "multiple_choice",
    question:
      "What should you avoid doing after a court hearing unless you’re legally trained?",
    options: [
  ...
  },
  {
    ...
    type: "multiple_choice",
    question:
      "If ICE arrests someone outside the courthouse, what should you do first?",
    options: [
