...
export const mentalHealthResilienceQuestions: Question[] = [
  {
    ...
    question: 'Why is resilience training important for volunteers in high-pressure environments?',
    options: [
  ...
  },
  {
    ...
    question: 'Which of these are examples of grounding or stabilization techniques taught in this course?',
    options: [
  ...
  },
  {
    id: 'q4',
    type: 'multiple_choice',
    question: 'Which physical stress signals should volunteers watch for during field actions?',
    options: [
  ...
  },
  {
    id: 'q5',
    type: 'true_false',
    question: 'Peer support check-ins should always include direct probing about trauma to ensure nothing is missed.',
    correct: false,
  },
  {
    id: 'q6',
  ...
  },
  {
    id: 'q7',
    type: 'multiple_select',
    question: 'Which practices align with the boundaries and self-care guidelines from this course?',
    options: [
  ...
  },
  {
    id: 'q8',
    type: 'multiple_choice',
    question: 'If a volunteer freezes and stares blankly during chaos, what is your first move?',
    options: [
  ...
  },
  {
    id: 'q9',
    type: 'true_false',
    question: 'Volunteers are expected to stabilize, not treat trauma or diagnose mental health conditions.',
    correct: true,
  },
  {
    id: 'q10',
    type: 'multiple_select',
    question: 'Which steps are recommended for maintaining resilience and preventing burnout?',
    options: [
