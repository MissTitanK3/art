...
export const FIELD_ROLE_OPTIONS = [
  ...
  'otg_general_support',
  'intake_greeter',
  'supplies_labeling_helper',
  'inventory_counter_basic',
  'charging_station_helper',
  'kid_zone_monitor',
  'clothing_weather_gear_sorter',
  'comfort_station_helper',
  'pet_support_helper',
  'chant_coordination_assist',
  'route_echoer',
  'buddy_finder',
  'heat_cold_monitor',
  'space_maker',
  'earplug_mask_distributor',
  'sign_direction_helper',
  'qr_code_placement_helper',
  'social_photo_assist',
  'tabling_queue_helper',
  'sticker_button_giver',
  'environmental_hazard_spotter',
  'soft_perimeter_helper',
  'calm_down_buddy',
  'flashlight_lantern_holder',
  'rain_cover_helper',
  'phone_number_writer',
  'otg_support',
] as const;
...
export const TEAM_CONFIG_PRESETS: Record<EventType, TeamConfigPreset> = {
  ...
  protest_high: {
    roles: {
      ...
      grounding_support: 1,
      resource_drop: 1,
      chant_coordination_assist: 2,
      route_echoer: 3,
      heat_cold_monitor: 2,
      earplug_mask_distributor: 2,
      environmental_hazard_spotter: 2,
      soft_perimeter_helper: 4,
      calm_down_buddy: 2,
      flashlight_lantern_holder: 2,
      phone_number_writer: 2,
      otg_support: 2,
    },
    actions: [
...
export const FIELD_ROLE_DETAILS: FieldRoleDetail[] = [
  ...
  {
    role: 'intake_greeter',
    description: 'Welcome people, point to right table.',
    requiredSkills: ['Friendly demeanor', 'Clear communication', 'Patience'],
    riskLevel: 'low',
    bestSuitedFor: 'Keeps anxiety low, stops bottlenecks.',
    trainingRequired: false,
  },
  {
    role: 'supplies_labeling_helper',
    description: 'Write labels, expiration, categories.',
    requiredSkills: ['Legible handwriting', 'Attention to detail', 'Organization'],
    riskLevel: 'low',
    bestSuitedFor: 'Rapid warehouse org.',
    trainingRequired: false,
  },
  {
    role: 'inventory_counter_basic',
    description: 'Count boxes, update tally board.',
    requiredSkills: ['Basic counting', 'Accuracy', 'Reliability'],
    riskLevel: 'low',
    bestSuitedFor: 'Prevent shortages and duplicates.',
    trainingRequired: false,
  },
  {
    role: 'charging_station_helper',
    description: 'Guide people to power, avoid tripping hazards.',
    requiredSkills: ['Safety awareness', 'Helpfulness', 'Cable management'],
    riskLevel: 'low',
    bestSuitedFor: 'Power is gold during long ops.',
    trainingRequired: false,
  },
  {
    role: 'kid_zone_monitor',
    description: 'Keep kids entertained near guardians.',
    requiredSkills: ['Patience with children', 'Playfulness', 'Vigilance'],
    riskLevel: 'low',
    bestSuitedFor: 'Lets parents volunteer.',
    trainingRequired: false,
  },
  {
    role: 'clothing_weather_gear_sorter',
    description: 'Size sorting, light support.',
    requiredSkills: ['Sorting speed', 'Organization', 'Helpfulness'],
    riskLevel: 'low',
    bestSuitedFor: 'Keeps cold/rain injuries down.',
    trainingRequired: false,
  },
  {
    role: 'comfort_station_helper',
    description: 'Water, chairs, resting guidance.',
    requiredSkills: ['Hospitality', 'Observational skills', 'Kindness'],
    riskLevel: 'low',
    bestSuitedFor: 'Stops burnout early.',
    trainingRequired: false,
  },
  {
    role: 'pet_support_helper',
    description: 'Bowls, leashes, quiet area.',
    requiredSkills: ['Comfort with animals', 'Calm presence', 'Safety awareness'],
    riskLevel: 'low',
    bestSuitedFor: 'People come with animals.',
    trainingRequired: false,
  },
  {
    role: 'chant_coordination_assist',
    description: 'Follow lead, help volume not messaging.',
    requiredSkills: ['Loud voice', 'Rhythm', 'Ability to follow cues'],
    riskLevel: 'low',
    bestSuitedFor: 'Amplifying the message.',
    trainingRequired: false,
  },
  {
    role: 'route_echoer',
    description: 'Relay direction with hand signals in noisy areas.',
    requiredSkills: ['Clear signaling', 'Visibility', 'Focus'],
    riskLevel: 'low',
    bestSuitedFor: 'Keeping the group together.',
    trainingRequired: false,
  },
  {
    role: 'buddy_finder',
    description: 'Pair newcomers with someone experienced.',
    requiredSkills: ['Social matchmaking', 'Welcoming vibe', 'Memory for faces'],
    riskLevel: 'low',
    bestSuitedFor: 'Ensuring no one is alone.',
    trainingRequired: false,
  },
  {
    role: 'heat_cold_monitor',
    description: 'Watch for heat exhaustion or shivering.',
    requiredSkills: ['Observation', 'Basic health awareness', 'Proactive care'],
    riskLevel: 'low',
    bestSuitedFor: 'Preventing weather-related illness.',
    trainingRequired: false,
  },
  {
    role: 'space_maker',
    description: 'Remind crowd to create aisles, non-authoritative.',
    requiredSkills: ['Gentle assertiveness', 'Spatial awareness', 'Politeness'],
    riskLevel: 'low',
    bestSuitedFor: 'Maintaining flow and safety.',
    trainingRequired: false,
  },
  {
    role: 'earplug_mask_distributor',
    description: 'PPE without medical advice.',
    requiredSkills: ['Hygiene awareness', 'Quick distribution', 'Approachability'],
    riskLevel: 'low',
    bestSuitedFor: 'Community health and safety.',
    trainingRequired: false,
  },
  {
    role: 'sign_direction_helper',
    description: 'Put up directional signs, ADA routes.',
    requiredSkills: ['Clarity', 'Tape/mounting skills', 'Accessibility awareness'],
    riskLevel: 'low',
    bestSuitedFor: 'Helping people find their way.',
    trainingRequired: false,
  },
  {
    role: 'qr_code_placement_helper',
    description: 'Stick QR info posters in smart spots.',
    requiredSkills: ['Visual placement', 'Reachability', 'Tape management'],
    riskLevel: 'low',
    bestSuitedFor: 'Information distribution.',
    trainingRequired: false,
  },
  {
    role: 'social_photo_assist',
    description: 'Non-face photos for IG, hand images, art.',
    requiredSkills: ['Photography', 'Privacy awareness (no faces)', 'Artistic eye'],
    riskLevel: 'low',
    bestSuitedFor: 'Documenting the vibe safely.',
    trainingRequired: false,
  },
  {
    role: 'tabling_queue_helper',
    description: 'Keep movement smooth, answer “Where do I go?”.',
    requiredSkills: ['Crowd flow', 'Friendly direction', 'Patience'],
    riskLevel: 'low',
    bestSuitedFor: 'Reducing confusion.',
    trainingRequired: false,
  },
  {
    role: 'sticker_button_giver',
    description: 'Joy builder, recruitment tool.',
    requiredSkills: ['Enthusiasm', 'Engagement', 'Generosity'],
    riskLevel: 'low',
    bestSuitedFor: 'Building morale.',
    trainingRequired: false,
  },
  {
    role: 'environmental_hazard_spotter',
    description: 'Notice holes, wires, glass, tell marshal.',
    requiredSkills: ['Sharp eyes', 'Safety focus', 'Communication'],
    riskLevel: 'low',
    bestSuitedFor: 'Preventing accidents.',
    trainingRequired: false,
  },
  {
    role: 'soft_perimeter_helper',
    description: 'Mark space limits with tape or cones.',
    requiredSkills: ['Spatial definition', 'Teamwork', 'Setup speed'],
    riskLevel: 'low',
    bestSuitedFor: 'Defining the space.',
    trainingRequired: false,
  },
  {
    role: 'calm_down_buddy',
    description: 'Sit with someone overwhelmed, stay present.',
    requiredSkills: ['Calm presence', 'Listening', 'Patience'],
    riskLevel: 'low',
    bestSuitedFor: 'Emotional support.',
    trainingRequired: false,
  },
  {
    role: 'flashlight_lantern_holder',
    description: 'Light up dark paths or tables.',
    requiredSkills: ['Steadiness', 'Helpfulness', 'Battery awareness'],
    riskLevel: 'low',
    bestSuitedFor: 'Safety in the dark.',
    trainingRequired: false,
  },
  {
    role: 'rain_cover_helper',
    description: 'Quick tarps, ponchos, umbrellas.',
    requiredSkills: ['Speed', 'Resourcefulness', 'Weather awareness'],
    riskLevel: 'low',
    bestSuitedFor: 'Staying dry.',
    trainingRequired: false,
  },
  {
    role: 'phone_number_writer',
    description: 'Sharpie key contacts on arms (scripted only).',
    requiredSkills: ['Legible writing', 'Consent', 'Accuracy'],
    riskLevel: 'low',
    bestSuitedFor: 'Emergency contact prep.',
    trainingRequired: false,
  },
  {
    role: 'otg_support',
...
export const FIELD_ROLE_TIERS: Record<FieldRole, 1 | 2 | 3 | 4> = {
  ...
  intake_greeter: 4,
  supplies_labeling_helper: 4,
  inventory_counter_basic: 4,
  charging_station_helper: 4,
  kid_zone_monitor: 3,
  clothing_weather_gear_sorter: 4,
  comfort_station_helper: 3,
  pet_support_helper: 4,
  chant_coordination_assist: 4,
  route_echoer: 4,
  buddy_finder: 3,
  heat_cold_monitor: 3,
  space_maker: 4,
  earplug_mask_distributor: 4,
  sign_direction_helper: 4,
  qr_code_placement_helper: 4,
  social_photo_assist: 4,
  tabling_queue_helper: 4,
  sticker_button_giver: 4,
  environmental_hazard_spotter: 3,
  soft_perimeter_helper: 4,
  calm_down_buddy: 3,
  flashlight_lantern_holder: 4,
  rain_cover_helper: 4,
  phone_number_writer: 4,
  otg_support: 4,
};
